...
const AdminLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'All Employees', href: '/employees', icon: UsersIcon },
    { name: 'Leave Management', href: '/leave-requests', icon: DocumentTextIcon },
    { name: 'Attendance Reports', href: '/attendance', icon: ClockIcon },
    ...
    <div className="h-screen flex overflow-hidden bg-gray-100">
      ...
      <div className={`fixed inset-0 flex z-40 md:hidden ${sidebarOpen ? '' : 'hidden'}`}>
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <SidebarContent navigation={navigation} isCurrentPath={isCurrentPath} userRole="admin" />
        </div>
      </div>
              ...
              <div className="w-full flex md:ml-0">
                <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                  <div className="flex items-center h-16">
                    <h1 className="text-2xl font-semibold text-gray-900">HRMS Admin Panel</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              <Routes>
                ...
                <Route path="/user-management" element={<div className="p-8 text-center text-gray-500">User Management - Coming Soon</div>} />
      ...
      <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        <div className="flex items-center flex-shrink-0 px-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <p className="text-sm font-medium text-gray-700">HRMS Admin</p>
              <p className="text-xs font-medium text-gray-500">Administrator Panel</p>
            </div>
          </div>
        </div>
