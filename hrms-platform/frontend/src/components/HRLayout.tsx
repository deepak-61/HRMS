...
const HRLayout: React.FC = () => {
  ...
  const navigation = [
    { name: 'HR Dashboard', href: '/dashboard', icon: HomeIcon },
    { name: 'Employees', href: '/employees', icon: UsersIcon },
    { name: 'Leave Requests', href: '/leave-requests', icon: DocumentTextIcon },
    { name: 'Attendance', href: '/attendance', icon: ClockIcon },
    { name: 'Recruitment', href: '/recruitment', icon: CalendarIcon },
    ...
    <div className="h-screen flex overflow-hidden bg-gray-100">
      ...
      <div className={`fixed inset-0 flex z-40 md:hidden ${sidebarOpen ? '' : 'hidden'}`}>
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <SidebarContent navigation={navigation} isCurrentPath={isCurrentPath} userRole="hr_manager" />
        </div>
      </div>
              ...
              <div className="w-full flex md:ml-0">
                <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                  <div className="flex items-center h-16">
                    <h1 className="text-2xl font-semibold text-gray-900">HR Management Portal</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="py-6">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              <Routes>
                ...
                <Route path="/recruitment" element={<div className="p-8 text-center text-gray-500">Recruitment Portal - Coming Soon</div>} />
                <Route path="/reports" element={<div className="p-8 text-center text-gray-500">HR Reports - Coming Soon</div>} />
        ...
        <div className="flex items-center flex-shrink-0 px-4">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-xs font-medium text-gray-500">HR Management</p>
            </div>
          </div>
        </div>
